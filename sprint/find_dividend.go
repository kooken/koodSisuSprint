...
The function should loop through the numbers from from (inclusive) to to (exclusive) and return the first number in that range
that is divisible by the divisor.
