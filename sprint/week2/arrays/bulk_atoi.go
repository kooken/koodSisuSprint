/*
Write a Go function that takes an array of strings, applies the StrToInt function you wrote earlier to every element in the array,
and returns the resulting integer values as a new array.
Note that you cannot call the StrToInt function from the package in our current learning environment, you have to copypaste
